...
import { Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress, WETH9 } from '@myunidavid/sdk-core'
import { abi } from '@myunidavid/swap-router-contracts/artifacts/contracts/interfaces/ISwapRouter02.sol/ISwapRouter02.json'
import { Trade as V2Trade } from '@myunidavid/v2-sdk'
import {
  encodeRouteToPath,
  FeeOptions,
  MethodParameters,
